<script lang="ts">
	...
	import NewGroupSheet from '../../_admin/groups/NewGroupSheet.svelte';
...
<DashboardPage5>
	...
	{#snippet footer()}
		<DashboardHelp5 title="Groups (superuser view)">
...
<NewGroupSheet bind:open={newGroupSheet} action="/dashboard/_admin/groups?/add" {group} />

<DeleteDialog
	bind:open={deleteGroupDialog}
	item={deleteItem}
	action="/dashboard/_admin/groups?/delete"
/>
